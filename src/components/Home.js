            ...
            <Row>
                ...
                <Col xs={12} md={6} className="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p className='text-center'>
                        Estudo programação há 3 anos, atualmente no 1º ano em Análise e Desenvolvimento de Sistemas. Busco vaga como programador Full Stack (React + Firebase) para desenvolver meus conhecimentos.
                    </p>
